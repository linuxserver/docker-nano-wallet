...
<!-- Please read the https://github.com/linuxserver/docker-nano-wallet/blob/dev/.github/CONTRIBUTING.md -->
...
Simply pulling `lscr.io/linuxserver/nano-wallet:dev` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  nano-wallet:
    image: lscr.io/linuxserver/nano-wallet:dev
...
docker run -d \
  ...
  -p 80:80 \
  --restart unless-stopped \
  lscr.io/linuxserver/nano-wallet:dev
```
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/nano-wallet:dev`
...
* Update the image: `docker pull lscr.io/linuxserver/nano-wallet:dev`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/nano-wallet:dev .
```
